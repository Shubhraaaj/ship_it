        ...
        <div class="relative bg-white overflow-hidden my-10">
            <div class="max-w-7xl mx-auto">
                ...
                <div className="mx-8 grid grid-cols-5 grid-rows-1">
                    ...
                    <img class="h-40 mx-auto" src="https://i.ibb.co/DfYyFP1/Click-to-add-a-heading-2.jpg" />
                    <img class="h-40 mx-auto" src="https://i.ibb.co/pw8Ymkg/Click-to-add-a-heading-3.jpg" />
                    <img class="h-40 mx-auto" src="https://i.ibb.co/cXD62yg/Click-to-add-a-heading.jpg" />  
                    <img class="h-40 mx-auto" src="https://i.ibb.co/2Mc59XR/Click-to-add-a-heading-4.jpg" />
                    <img class="h-40 mx-auto" src="https://i.ibb.co/YW4zYdN/Click-to-add-a-heading-1.jpg" />
                </div>
            </div>
        </div>
    );
