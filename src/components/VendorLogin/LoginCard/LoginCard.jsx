...
export default function LoginCard(){
    ...
    return(
        <div className="rounded-lg shadow-lg bg-white max-w-sm p-12">
            ...
            <input type="email" className=" mx-auto mt-8 form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded-3xl transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" placeholder="Your email" />
            <input type="password" className=" mx-auto my-8 form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded-3xl transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" placeholder="Your password" />
            ...
            <Link to='/vendor_profile'>
                <button type="button" className="btn btn-primary bg-red-500 text-white font-medium w-full rounded-3xl py-2 my-4">SIGN IN</button>
            </Link>
