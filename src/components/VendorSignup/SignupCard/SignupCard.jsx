export default function SignupCard(){
    return(
        <div class="rounded-lg shadow-lg bg-white max-w-sm px-12 py-8">
            <h1 className="text-4xl tracking-tight font-medium text-gray-900 sm:text-5xl md:text-4xl">Create Account</h1>
            ...
            <button type="button" class="btn btn-primary font-medium bg-red-500 text-white w-full rounded-3xl py-3">CREATE ACCOUNT</button>
        </div>
    );
}