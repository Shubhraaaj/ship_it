    ...
    return(
        <div>
            <div className="w-full px-12 py-8 bg-red-100 rounded-3xl shadow-lg">
                ...
                <div id="otp" class={otpView?"flex flex-row justify-center text-center px-2 mt-5":"hidden"}> <input class="m-2 border h-10 w-10 text-center form-control rounded" type="text" id="first" maxlength="1" /> <input class="m-2 border h-10 w-10 text-center form-control rounded" type="text" id="second" maxlength="1" /> <input class="m-2 border h-10 w-10 text-center form-control rounded" type="text" id="third" maxlength="1" /> <input class="m-2 border h-10 w-10 text-center form-control rounded" type="text" id="fourth" maxlength="1" /> <input class="m-2 border h-10 w-10 text-center form-control rounded" type="text" id="fifth" maxlength="1" /> <input class="m-2 border h-10 w-10 text-center form-control rounded" type="text" id="sixth" maxlength="1" /> </div>
                {/* {otpView && <button className="btn btn-primary text-center font-medium underline text-red-500 mt-4">Resend OTP</button>} */}
                {otpView && <div class="flex justify-center text-center mt-5"> <a class="flex items-center text-red-400 hover:text-red-600 cursor-pointer"><span class="font-bold">Resend OTP</span><i class='bx bx-caret-right ml-1'></i></a> </div>}
