        ...
        <div className="p-12 bg-red-100 rounded-3xl shadow-lg">
            ...
            <div className="grid grid-cols-2 grid-rows-1 space-x-8">
                <div class="relative w-full">
                    <input type="text" maxLength="3" defaultValue="0.1" class="mt-8 w-full form-control px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded-xl transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" placeholder="Weight" autofocus="autofocus"/>
                    <span class="absolute text-gray-500 block z-9 top-10 right-4">grams</span>
                </div>
                <select
