    ...
    return(
        <div className="p-12 bg-red-100 rounded-3xl shadow-lg">
            ...
            <div className="grid grid-cols-2 grid-rows-1 space-x-8">
                <select
                    class="mt-8 form-control px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded-xl transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" 
                    placeholder="Source">
                        <option value="grapefruit">Dhanbad</option>
                        <option value="lime">Patna</option>
                        <option selected value="coconut">Bangalore</option>
                        <option value="mango">Delhi</option>
                </select>
                <select
                    class="mt-8 form-control px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded-xl transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" 
